...
export default {
  ...
  directives: {
    test: {
      /*
        Disegna il misuratore per i componenti 
      */
      update: function(el) {
        ...
        function draw() {
          ...
          for (var i = 0; i < 360; i += 10) {
            ...
            !(i % 30) &&
              radialLineAtAngle(i / 360.0, bigLine, bigStart, raggio, "grey");
          }
          ...
          function info(text, font, posX, posY, color) {
            c.save();
            c.font = font + "px Roboto Mono, monospace";
            c.fillStyle = color;
